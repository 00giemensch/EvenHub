...
class ExploreCategoryCell: UICollectionViewCell {
    static let cellID = "ExploreCategoryCell"
    //MARK: - Properties
    ...
    private func setupBackgroundView() {
        ...
        switch category {
        case .art:
            self.backgroundColor = UIColor(resource: .accentDarkCyan)
        case .sport:
            self.backgroundColor = UIColor(resource: .accentRed)
        case .food:
            self.backgroundColor = UIColor(resource: .accentGreen)
        case .music:
            self.backgroundColor = UIColor(resource: .accentOrange)
        }
    }
